...
public class Main {
	...
	public static void main(String[] args) {
		...
		Usuario usuario1 = new Usuario("admin", "1234", null, null, null);
		Usuario usuario2 = new Usuario("empresa", "1234", null, empresa, null);
		Usuario usuario5 = new Usuario("empresa2", "1234", null, empresa2, null);
		Usuario usuario6 = new Usuario("empresa3", "1234", null, empresa3, null);
		Usuario usuario3 = new Usuario("cliente", "1234", cliente, null, null);
		Usuario usuario4 = new Usuario("cliente2", "1234", cliente2, null, null);
	...
	public static Venda criarVenda(List<Produto> carrinho, Empresa empresa, Cliente cliente, List<Venda> vendas) {
		...
		Venda venda = new Venda(idVenda, carrinho.stream().toList(), total, comissaoSistema, empresa, cliente, null);
